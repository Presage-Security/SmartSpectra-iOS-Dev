...
extension ViewController.Screening.Root: PresagePreprocessingDelegate {
    ...
    public func errorHappened(_ errorCode: Int32) {
        ...
        switch errorCode {
        case 1: showToast(msg: "No face found")
        case 2: showToast(msg: "Only one face permitted")
        case 3: showToast(msg: "Move closer to camera")
        case 4: showToast(msg: "Stay within the screen")
        case 5: showToast(msg: "Need more light")
        case 6: showToast(msg: "Chest must be visible")
        default:
            showToast(msg: "All good")
        }
        while errorCode != 0 {
            buttonState = .disable
